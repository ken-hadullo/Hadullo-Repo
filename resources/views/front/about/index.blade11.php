            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        ...
                        <div class="cont">
                            <div class="rapa">
                              <div class="title"> <img class="img-fluid" src="assets/front/img/tum-logo.jpg" alt="" class = "logo-login" width="100" height="100">
                                </div>
                              ...
                              <form  method="POST" action="{{ route('login') }}">
                                ...
                                <div class="row">
                                  ...
                                  <input type="email" name = "email"   @error('email') is-invalid @enderror  id = "email" value="{{ old('email') }}" placeholder="Email" required>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2 pt-2">
                        <div class="col-4">
                            <img class="assets/front/img-fluid bg-light p-1" src="img/course-1.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="assets/front/img-fluid bg-light p-1" src="img/course-2.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="assets/front/img-fluid bg-light p-1" src="img/course-3.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="assets/front/img-fluid bg-light p-1" src="img/course-2.jpg" alt="">
                        </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">LARA LMS 2025</a>, All Right Reserved.
