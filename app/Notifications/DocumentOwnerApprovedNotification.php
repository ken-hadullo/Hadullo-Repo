...
class DocumentOwnerApprovedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('New Document Approved: ' . $this->document->proposal_title)
    ...
    public function toArray($notifiable)
    {
        ...
        $notificationData = [
            ...
            'message' => 'A new document titled "' . $this->document->proposal_title . '" has been approved.',
